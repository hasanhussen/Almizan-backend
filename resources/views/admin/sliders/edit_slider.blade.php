                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="slider_title"
                                class="form-control @error('type') is-invalid @enderror" placeholder="Enter slider name"
                                value="{{ old('slider_title', $slider->slider_title) }}" required>
                            @error('slider_title')
                        ...
                        <div class="col-md-6">
                            ...
                            @if ($slider->image)
                                <div class="mb-2">
                                    <img src="{{ asset('storage/' . $slider->image) }}" alt="slider image" id="currentImage"
